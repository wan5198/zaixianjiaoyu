...
from django.core.mail import send_mail #邮件发送模块

from apps.users.models import EmailVerifyRecord #引入自己的表
from zxjy2018.settings import EMAIL_FROM #从总配置文件里引入邮箱地址
